                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Table Data Laporin Kategori <b><?=$jenis_laporan?></b></h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <?php foreach ($jenis_masalah as $key => $value) {?>
                                                <a class="dropdown-item" href="<?=base_url();?>laporin/kategori/<?=$value['id_jenis_masalah']?>" ><?=$value['nama_jenis_masalah']?></a>
                                                <?php } ?>
                                            </div>
                                        </div>
