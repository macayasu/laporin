                ...
                <tbody>
                    <tr style="height:100.2pt;">
                        <td colspan="3"
                            ...
                            <p style="margin-top:0pt; margin-bottom:0pt; text-align:center; font-size:11pt;">
                                <strong>DINAS TENAGA KERJA DAN TRANSMIGRASI KABUPATEN OGAN ILIR</strong>
                            </p>
                            <p style="margin-top:0pt; margin-bottom:10pt; text-align:center; font-size:11pt;">JL. RAYA
                                LINTAS TIMUR INDRALAYA KM 35 Telp. (0711) 580 600 INDRALAYA</p>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3"
